...
Employee e=new Employee(); 
	...
	public void displayEmpDetails() {
		...
		if((e.salary>=5000 && e.salary<30000) && e.designation.equalsIgnoreCase("System Associate"))
			e.insuranceScheme="Scheme C";
		else if((e.salary>=30000 && e.salary<50000) && e.designation.equalsIgnoreCase("Programmer"))
			e.insuranceScheme="Scheme B";
		else if(e.salary>=50000 && e.designation.equalsIgnoreCase("Manager"))
