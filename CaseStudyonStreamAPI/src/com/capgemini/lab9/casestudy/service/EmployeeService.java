package com.capgemini.lab9.casestudy.service;
...
import com.capgemini.lab9.casestudy.employeemain.EmployeeMain;
...
public class EmployeeService {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedReader sc_br = new BufferedReader(new InputStreamReader(System.in));
		EmployeeMain empRep=new EmployeeMain();
		int choice;
		char c='y';
		while(c!='n' && c!='N' && c!='0') {
